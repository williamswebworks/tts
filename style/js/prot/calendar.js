...
Calendar.DAY_NAMES = new Array('Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado', 'Domingo');
Calendar.SHORT_DAY_NAMES = new Array('D', 'L', 'M', 'M', 'J', 'V', 'S', 'D');
Calendar.MONTH_NAMES = new Array('Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre');
Calendar.SHORT_MONTH_NAMES = new Array('Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic');
Calendar.LANG_TODAY = 'Hoy';
...
Calendar.setup = function(params) {
	...
	if (params.parentElement) {
		...
		triggerElement._click(function() {
...
Calendar.prototype = {
	...
	create: function(parent) {
		...
		this._drawButtonCell(row, Calendar.LANG_TODAY, 3, Calendar.NAV_TODAY);
